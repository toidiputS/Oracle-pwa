                            ...
                            <div>
                                ...
                                {agent.squad && (
                                    <div className="mt-2 flex items-center gap-2">
                                        ...
                                        <span className="text-[8px] sm:text-[10px] text-cyan-300 font-black uppercase tracking-[0.2em]">
                                            {agent.squad.id} // {agent.squad.name} <span className="text-cyan-500/60">[{agent.squad.domain}]</span>
                                        </span>
                                    </div>
                                )}
                            </div>
